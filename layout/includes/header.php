        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                echo (!$left) ? ' pull-right' : ' pull-left'; ?>">
                    ...
                    <?php } else { ?> 
                        <a class="headerlogo" <?php echo 'style=" background-image:url(\''.preg_replace("(https?:)", "", $CFG->wwwroot).'/sebtsimages/headerlogo.png\')"' ?>  href="http://cert.sebts.edu" title="Home"></a>  <!-- SEBTS -->
                    <?php } ?>
                </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="pull-<?php echo ($left) ? 'right' : 'left'; ?>">
                        <div class="usermenu">
                            ...
                            <?php echo $OUTPUT->custom_SEBTS_nav_buttons($PAGE); ?>  <!-- SEBTS CUSTOM -->
                        </div>
